    ...
    def __init__(
        ...
        if crop_type == 'rand_crop':
            self.transform = Compose([
                ...
                ColorJitterEdgeSafe(brightness=0.2, saturation=0.2),
                ToTensor()
            ])
...
class ColorJitterEdgeSafe(T.ColorJitter):
    def __init__(self, brightness=0.2, saturation=0.2, p=0.8):
        super().__init__(brightness=brightness, saturation=saturation)
        self.p = p
